        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between gap-4 md:gap-8">
          ...
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden lg:flex items-center space-x-6 font-bold text-sm">
              ...
              <Link to="/mockup-generator" className="hover:text-primary transition-colors">Mockup</Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-text-muted">
                ...
                <li><Link to="/mockup-generator" className="hover:text-primary transition-colors">Mockup</Link></li>
              </ul>
            </div>
