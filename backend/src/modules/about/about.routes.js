...
router.post('/team-members/:id', protect, admin, ctrl.teamMembers.update);
...
router.post('/stat-counters/:id', protect, admin, ctrl.statCounters.update);
...
router.post('/value-props/:id', protect, admin, ctrl.valueProps.update);
...
router.post('/process-pillars/:id', protect, admin, ctrl.processPillars.update);
...
router.post('/partner-brands/:id', protect, admin, ctrl.partnerBrands.update);
