...
const SEO = ({ title, description, name, type, image }) => {
  const defaultTitle = "Zeprr - Premium Custom Printing & Packaging";
  ...
  return (
    <Helmet>
      ...
      <title>{title ? `${title} | Zeprr` : defaultTitle}</title>
      ...
      <meta property="og:site_name" content={name || "Zeprr"} />
      
      {/* Twitter tags */}
      <meta name="twitter:creator" content={name || "Zeprr"} />
